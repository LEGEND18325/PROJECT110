...
data=file['responses'].tolist()

figure=ff.create_distplot([data],['Responses'],show_hist=False)
figure.show()
...
def showFigure(data2):
    ...
    figure=ff.create_distplot([file],['Responses'],show_hist=False)
...
def setup():
    ...
    for i in range(0,100):
        randomData=dataOFMediumData(30)
